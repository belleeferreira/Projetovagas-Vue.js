      ...
      <div class="col">
        <div class="form-group">
          ...
          <input
            type="text"
            class="form-control"
            placeholder="Pesquise por palavra chave, por exemplo 'PHP', 'Pleno', 'Analista'" v-model="titulo" />
          <small class="form-text text-muted"
            >Informe palavras que estejam relacionadas com o título que você
            procura</small
          >
        </div>
      </div>
